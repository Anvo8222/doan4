<%@ Page Title="" Language="C#" MasterPageFile="~/khachhang/Home.Master" AutoEventWireup="true" CodeBehind="XacNhanQuenMK.aspx.cs" Inherits="wsbqa.khachhang.XacNhanQuenMK" %>
            ...
            <div action="" class="form">
                <div class="form-signup">
                    ...
                    <div class="signup__footer">
                        <asp:Button ID="btnDangKy" class="signup__footer-link" runat="server" Text="Xác nhận" OnClick="btnDangKy_Click" />
