<%@ Page Title="" Language="C#" MasterPageFile="~/nhacungcap/nhacungcap.Master" AutoEventWireup="true" CodeBehind="ChinhSuaTTCaNhanNCC.aspx.cs" Inherits="wsbqa.nhacungcap.ChinhSuaTTCaNhanNCC" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../css/ChinhSuaTTCaNhanNCC.css" rel="stylesheet" />
    <style>
			.main{
            margin:auto;
            width:1000px;
