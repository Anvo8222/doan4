...
{
    public partial class ChinhSuaDM : System.Web.UI.Page
    {
        ...
        {
            GridView1.DataSource = kn.laydata("SELECT * FROM DANHMUCSANPHAM WHERE TINHTRANG=N'đã xác nhận' order by IDDANHMUC DESC");
